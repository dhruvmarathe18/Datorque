...
import { Card, CardBody, Button, Input, Avatar, PageLoader, Alert } from '@/components/portal/ui';
import { formatDate, formatTime } from '@/lib/utils';
import { Send, Search, Users, ArrowLeft, Paperclip, Image, X, Loader2 } from 'lucide-react';
import { Chat, User } from '@/types/portal';
...
export default function ChatPage() {
  ...
  const sendMessage = async (content: string, contentType: 'text' | 'image' | 'file' = 'text', fileUrl?: string, fileName?: string) => {
    ...
    try {
      ...
      const { error: sendError } = await (supabase.from('chat_messages') as any).insert([{
